...
export default function Modal({ isOpen, onClose }) {
  ...
  return (
    <div className='fixed inset-0 z-50 bg-black/40 backdrop-blur-sm'>
      ...
      <div className='relative z-40 flex h-screen flex-col justify-between py-6'>
        ...
        <div className='container mx-auto px-4'>
          <h4 className='text-background text-3xl font-bold lg:text-5xl'>
            Our <i className='font-medium'>new</i> website is currently <u>under construction</u>.
          </h4>
          <p className='text-background mt-20 mb-24 text-2xl leading-[1.2] font-bold lg:text-[42px]'>
            We are in the <i className='font-medium'>process</i> of <u>designing</u> and <u>developing</u> the{' '}
            <u>full digital presence of our studio</u>. In the meantime, you can browse a{' '}
            <i className='font-medium'>short portfolio</i> featuring selected projects. Thank you for your <u>trust</u>{' '}
            and continued <u>support</u> over the years!
          </p>
          <p className='text-background text-xl leading-[1.2] font-bold lg:text-[32px]'>
            Stay <i className='font-medium'>creatively</i> <u>drunk</u>.
          </p>
        </div>
